...
/// <summary>
/// We use this generic type to store values into <see cref="CommandInvocationContext.Extensions"/>.
...
/// <see cref="CommandInvocationContext.Extensions"/> under type T (by the application or another library),
...
/// </summary>
/// <typeparam name="T">The type of the value to store into <see cref="CommandInvocationContext.Extensions"/>.</typeparam>

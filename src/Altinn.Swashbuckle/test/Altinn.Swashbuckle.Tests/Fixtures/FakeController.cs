...
public class FakeController
{
    ...
    { }
    public void ActionHavingFromFormAttributeWithSwaggerIgnore([FromForm] SwaggerIgnoreAnnotatedType param1)
    { }
    public void ActionHavingEnum(IntEnum param1)
    { }
    public void ActionHavingFromFormObjectAndString([FromForm] SwaggerIgnoreAnnotatedType param1, [FromForm] string param2)
    { }
}

    ...
    : XmlDocFilterTestsBase
{
    ...
    public void Apply_SetsDescriptionAndExample_FromActionParamTag()
    {
        ...
        var filterContext = new ParameterFilterContext(apiParameterDescription, null, null, new OpenApiDocument(), parameterInfo: parameterInfo);
        ...
        ToJsonString(parameter.Example).ShouldBe("\"Example for \\\"param1\\\"\"");
    }
    ...
    public void Apply_SetsDescriptionAndExample_FromUriTypeActionParamTag()
    {
        ...
        parameter.Example.ShouldNotBeNull();
        ToJsonString(parameter.Example).ShouldBe("\"http://test.com/?param1=1&param2=2\"");
    }
    ...
    public void Apply_SetsDescriptionAndExample_FromPropertySummaryAndExampleTags()
    {
        ...
        var apiParameterDescription = new ApiParameterDescription { };
        var filterContext = new ParameterFilterContext(apiParameterDescription, null, null, new OpenApiDocument(), propertyInfo: propertyInfo);
        ...
        parameter.Example.ShouldNotBeNull();
        ToJsonString(parameter.Example).ShouldBe("\"Example for StringProperty\"");
    }
    ...
    public void Apply_SetsDescriptionAndExample_FromUriTypePropertySummaryAndExampleTags()
    {
        ...
        parameter.Schema.Description.ShouldBeNull();
        parameter.Example.ShouldNotBeNull();
        ToJsonString(parameter.Example).ShouldBe("\"https://test.com/a?b=1&c=2\"");
    }

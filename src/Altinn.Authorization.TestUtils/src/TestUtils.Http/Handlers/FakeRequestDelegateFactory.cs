...
internal static class FakeRequestDelegateFactory
{
    ...
    private abstract class ResultExecutor
    {
        public static ResultExecutor ForResultType(Type type)
        {
            ...
            {
                var inner = ForResultType(typeof(JsonContent));

                return new ConvertResultExecutor<JsonDocument>(static doc => JsonContent.Create(doc), inner);
            }
            ...
            if (type == typeof(JsonElement))
            {
                ...
                return new ConvertResultExecutor<JsonElement>(static elem => JsonContent.Create(elem), inner);
            }

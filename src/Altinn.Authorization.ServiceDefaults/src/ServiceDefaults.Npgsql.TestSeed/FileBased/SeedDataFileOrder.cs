...
internal readonly record struct SeedDataFileOrder
    : IComparisonOperators<SeedDataFileOrder, SeedDataFileOrder, bool>
    , IEqualityOperators<SeedDataFileOrder, SeedDataFileOrder, bool>
{
    ...
    /// <inheritdoc/>
    public static bool operator >(SeedDataFileOrder left, SeedDataFileOrder right)
    ...
    {
        // 0 is explicitly not a valid value as that is used to indicate that the value is not set.

    ...
    , IVisitableKeyValueUrn
{
        ...
        , ISpanParsable<Test1>
    {
        ...
        /// <inheritdoc/>
        [CompilerGenerated]
        public static new Test1 Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
        ...
        [CompilerGenerated]
        public static new Test1 Parse(ReadOnlySpan<char> s)
        {
        ...
        /// <inheritdoc/>
        [CompilerGenerated]
        public static new Test1 Parse(string? s, IFormatProvider? provider)
        {
            ArgumentNullException.ThrowIfNull(s);
        ...
        [CompilerGenerated]
        public static new Test1 Parse(string? s)
        {
            ArgumentNullException.ThrowIfNull(s);

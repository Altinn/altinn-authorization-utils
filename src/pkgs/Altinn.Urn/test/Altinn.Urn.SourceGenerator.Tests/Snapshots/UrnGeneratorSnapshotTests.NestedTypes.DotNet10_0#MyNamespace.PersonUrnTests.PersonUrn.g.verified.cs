...
partial class PersonUrnTests
{
        ...
        , IVisitableKeyValueUrn
    {
        ...
        {
            return Impl<int>(segment, provider, out value);
        ...
        /// <summary>Type of <see cref="PersonUrn" />.</summary>
        [CompilerGenerated]
        public enum Type
        {
            /// <summary>Urn is a <see cref="PersonUrn.PartyId" />.</summary>
            PartyId = 1,
            /// <summary>Urn is a <see cref="PersonUrn.PartyUuid" />.</summary>
            PartyUuid = 2,
        }

        /// <summary>A PartyId variant of <see cref="PersonUrn"/>.</summary>
        [CompilerGenerated]
        [DebuggerDisplay("{DebuggerDisplay}")]
            ...
            , ISpanParsable<PartyId>
        {
            ...
            [CompilerGenerated]
            private static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, string? original, [MaybeNullWhen(false)] out PartyId result)
            {
                if (s.StartsWith("urn:altinn:party:id"))
                {
                    var s_0 = s.Slice(19);

                    if (s_0.Length > 1 && s_0[0] == ':' && TryParsePartyId(s_0.Slice(1), provider, out int s_0_value))
                    {
                        result = PartyId.FromParsed(original ?? new string(s), 20, s_0_value);
                        return true;
                    }
            ...
            /// <inheritdoc/>
            [CompilerGenerated]
            public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out PartyId result)
                => TryParse(s, provider, original: null, out result);

            /// <inheritdoc cref="ISpanParsable{TSelf}.TryParse(ReadOnlySpan{char}, IFormatProvider?, out TSelf)"/>
            [CompilerGenerated]
            public static bool TryParse(ReadOnlySpan<char> s, [MaybeNullWhen(false)] out PartyId result)
                => TryParse(s, provider: null, original: null, out result);
            ...
            public static PartyId Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
            {
                ...
                {
                    throw new FormatException("Could not parse PartyId");
                }
            ...
            /// <inheritdoc/>
            [CompilerGenerated]
            public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out PartyId result)
                => TryParse(s.AsSpan(), provider, original: s, out result);

            /// <inheritdoc cref="IParsable{TSelf}.TryParse(string, IFormatProvider?, out TSelf)"/>
            [CompilerGenerated]
            public static bool TryParse([NotNullWhen(true)] string? s, [MaybeNullWhen(false)] out PartyId result)
                => TryParse(s.AsSpan(), provider: null, original: s, out result);
            ...
            public static PartyId Parse(string? s, IFormatProvider? provider)
            {
                ...
                if (!TryParse(s.AsSpan(), provider, original: s, out PartyId? result))
                {
                    throw new FormatException("Could not parse PartyId");
                }
            ...
            public static PartyId Parse(string? s)
            {
                ...
                if (!TryParse(s.AsSpan(), provider: null, original: s, out PartyId? result))
                {
                    throw new FormatException("Could not parse PartyId");
                }
        ...
        /// <summary>A PartyUuid variant of <see cref="PersonUrn"/>.</summary>
        [CompilerGenerated]
        [DebuggerDisplay("{DebuggerDisplay}")]
        [System.Text.Json.Serialization.JsonConverterAttribute(typeof(Altinn.Urn.Json.UrnVariantJsonConverterFactory<MyNamespace.PersonUrnTests.PersonUrn, MyNamespace.PersonUrnTests.PersonUrn.Type>))]
            ...
            , ISpanParsable<PartyUuid>
        {
            ...
            [CompilerGenerated]
            private static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, string? original, [MaybeNullWhen(false)] out PartyUuid result)
            {
            ...
            /// <inheritdoc/>
            [CompilerGenerated]
            public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out PartyUuid result)
                => TryParse(s, provider, original: null, out result);

            /// <inheritdoc cref="ISpanParsable{TSelf}.TryParse(ReadOnlySpan{char}, IFormatProvider?, out TSelf)"/>
            [CompilerGenerated]
            public static bool TryParse(ReadOnlySpan<char> s, [MaybeNullWhen(false)] out PartyUuid result)
                => TryParse(s, provider: null, original: null, out result);
            ...
            public static PartyUuid Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
            {
                ...
                {
                    throw new FormatException("Could not parse PartyUuid");
                }
            ...
            /// <inheritdoc/>
            [CompilerGenerated]
            public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out PartyUuid result)
                => TryParse(s.AsSpan(), provider, original: s, out result);

            /// <inheritdoc cref="IParsable{TSelf}.TryParse(string, IFormatProvider?, out TSelf)"/>
            [CompilerGenerated]
            public static bool TryParse([NotNullWhen(true)] string? s, [MaybeNullWhen(false)] out PartyUuid result)
                => TryParse(s.AsSpan(), provider: null, original: s, out result);
            ...
            public static PartyUuid Parse(string? s, IFormatProvider? provider)
            {
                ...
                if (!TryParse(s.AsSpan(), provider, original: s, out PartyUuid? result))
                {
                    throw new FormatException("Could not parse PartyUuid");
                }
            ...
            public static PartyUuid Parse(string? s)
            {
                ...
                if (!TryParse(s.AsSpan(), provider: null, original: s, out PartyUuid? result))
                {
                    throw new FormatException("Could not parse PartyUuid");
                }

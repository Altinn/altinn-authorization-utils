...
namespace Altinn.Authorization.CommandLine.XmlDoc;
...
public interface IXmlDocProvider
{
    ...
    /// </summary>
    /// <param name="parameter">The parameter to get XML documentation for.</param>
    /// <param name="node">Output <see cref="XPathNavigator"/> with documentation for <paramref name="parameter"/>, if it exists.</param>
    /// <returns><see langword="true"/> if documentation for <paramref name="parameter"/> was found, otherwise <see langword="false"/>.</returns>

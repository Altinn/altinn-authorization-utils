...
internal sealed record JsonObjectNode
    : JsonContainerNode
{
    private static readonly Notation OpenNotation = Notation.Text("{", JsonStyles.Braces);
    private static readonly Notation CloseNotation = Notation.Text("}", JsonStyles.Braces);

    private readonly ImmutableArray<JsonPropertyNode> _children;

    private protected override Notation Open => OpenNotation;
    private protected override Notation Close => CloseNotation;

    internal JsonObjectNode(ImmutableArray<JsonPropertyNode> children)
    {

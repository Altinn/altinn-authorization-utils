...
public class OptionalPlainDiscriminatorTests
{
    [Fact]
    ...
    public record Base
    {
        public Base(FieldValue<VariantType> type)
        {
            Type = type;
        }

        [PolymorphicDiscriminatorProperty]
        public FieldValue<VariantType> Type { get; }
    ...
    public record RightChild
        : Base
    {
        public RightChild(FieldValue<VariantType> type)
            : base(type)
        {
        }
    ...
    [PolymorphicFieldValueRecord]
    public record RightGrandChild(FieldValue<VariantType> type)
        : RightChild(type)
    {
